        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center justify-center gap-2 flex-1 sm:flex-none px-3 sm:px-4 py-2 border border-slate-200 dark:border-slate-700
                         text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-800
                         text-sm font-medium rounded-lg transition-colors whitespace-nowrap"
            >
              <Upload className="w-4 h-4" /> <span className="hidden sm:inline">Import from </span>LinkedIn
            </button>
            <button
              onClick={() => setShowModal(true)}
              className="flex items-center justify-center gap-2 flex-1 sm:flex-none px-3 sm:px-4 py-2 bg-indigo-600 hover:bg-indigo-700
                         text-white text-sm font-medium rounded-lg transition-colors whitespace-nowrap"
            >
              <Plus className="w-4 h-4" /> Add<span className="hidden sm:inline"> Contact</span>
            </button>
          </div>
        </div>
